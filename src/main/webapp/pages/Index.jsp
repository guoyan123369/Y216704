...
<div id="layout_div" class="easyui-layout">
    ...
    <div data-options="region:'west',split:false,title:'菜单',collapsible:false" style="width:170px;">
        <div id="menu" class="easyui-accordion" fit="true">
            ...
            <div title="考试相关" data-options="iconCls:'icon-print'" style=" overflow:auto;padding:10px;">
                <ul class="easyui-tree">
                    <li><a href="javascript:;" class="btn_menu" url="${pageContext.request.contextPath}/pages/examimport.jsp">考试答案录入</a></li>
